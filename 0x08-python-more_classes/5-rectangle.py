...
class Rectangle():
    ...
    def __init__(self, width=0, height=0):
        """
        initializing the method for object creation
        """
        self.width = width
        self.height = height
    ...
    def __str__(self):
        ...
        or print() is called, representing the rectangle
        with charcter #
        And Return string rep for the rectangle
        """
        string = ""
    ...
    def __repr__(self):
        ...
        is called, or eval()
        And Return the string reprisentation of the rectangle
        """
        string = "Rectangle("
